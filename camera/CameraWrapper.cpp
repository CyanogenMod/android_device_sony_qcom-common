...
static char hdr_scene_mode_values[] =
{"auto,hdr,portrait,landscape,night,night-portrait,beach,snow,fireworks,sports,party,barcode,document,backlight,backlight-portrait,sweep-stitch,dark,dish,pet,baby,spot-light,soft-skin,anti-motion-blur,handheld-twilight,high-sensitivity"};
...
void camera_fixup_capability(android::CameraParameters *params){
    ...
    if(strstr(supportedIsModes,VALUE_SONY_STILL_HDR) != NULL){
        ...
        params->set(android::CameraParameters::KEY_SUPPORTED_SCENE_MODES, hdr_scene_mode_values);
    }
...
static char * camera_fixup_getparams(int id, const char * settings)
{
    ...
    params.set(android::CameraParameters::KEY_SUPPORTED_ISO_MODES, isoModeList);
