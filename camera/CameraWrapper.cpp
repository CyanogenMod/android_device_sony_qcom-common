...
{"auto,hdr,portrait,landscape,night,night-portrait,beach,snow,fireworks,sports,party,barcode,document,backlight,backlight-portrait,sweep-stitch,dark,dish,pet,baby,spot-light,soft-skin,anti-motion-blur,handheld-twilight,high-sensitivity,", "auto"};
...
static char * camera_fixup_getparams(int id, const char * settings)
{
    ...
    //params.set(android::CameraParameters::KEY_SUPPORTED_ISO_MODES, android::CameraParameters::KEY_EX_SUPPORTED_ISO);
...
char * camera_fixup_setparams(int id, const char * settings)
{
    ...
    /*if (params.get(android::CameraParameters::KEY_ISO_MODE)) {
        ...
        params.set(android::CameraParameters::KEY_EX_ISO, isoMode);
    }
    ...
    if (params.get(android::CameraParameters::KEY_SCENE_MODE)) {
        ...
        if (strcmp(sceneMode, android::CameraParameters::KEY_HIGH_DYNAMIC_RANGE_IMAGING) == 0) {
            params.set(android::CameraParameters::EX_IS_ON_STILL_HDR, android::CameraParameters::EX_IS_ON);
            params.set(android::CameraParameters::KEY_SCENE_MODE, android::CameraParameters::SCENE_MODE_AUTO);
        }
    }

    if (params.get(android::CameraParameters::KEY_RECORDING_HINT)) {
        if (strcmp(params.get(android::CameraParameters::KEY_RECORDING_HINT), android::CameraParameters::TRUE)) {
            params.set(android::CameraParameters::KEY_EX_VIDEO_STABILIZER, android::CameraParameters::EX_ON);
        } else {
            params.set(android::CameraParameters::KEY_EX_IMAGE_STABILIZER, android::CameraParameters::EX_ON);
        }
    }*/
