...
{"auto,sony-hdr,portrait,landscape,night,night-portrait,beach,snow,fireworks,sports,party,barcode,document,backlight,backlight-portrait,sweep-stitch,dark,dish,pet,baby,spot-light,soft-skin,anti-motion-blur,handheld-twilight,high-sensitivity,", "auto"};
...
char * camera_fixup_setparams(int id, const char * settings)
{
    ...
    //for now we can force the HDR state as the camera app crashes when setting it
